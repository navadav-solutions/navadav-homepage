...
interface ConversemosButtonProps {
  isVisible: boolean;
}

const ConversemosButton = ({ isVisible }: ConversemosButtonProps) => {
  return (
    <button
      ...
      style={{
        background:
          "radial-gradient(50% 50% at 50% 50%, #0743D7 0%, #2D69FD 100%)",
        boxShadow:
          "0 -4px 4px 0 rgba(3, 47, 157, 0.40) inset, 0 4px 4px 0 rgba(250, 251, 255, 0.40) inset",
...
export default ConversemosButton;
