  ...
  return (
    <section className="flex flex-col items-start justify-start w-full bg-white rounded-[104px] rounded-b-[96px] w-full lg:w-[615px]">
      <div className="relative w-full aspect-[615/350] rounded-t-[104px] overflow-hidden">
        <Image src={imageSrc} alt="Service" fill className="object-cover" />
      </div>
      <div className="flex flex-col items-start justify-start py-[32px] px-[50px] w-full">
        <h3 className="text-[24px] font-[700] text-[#2B2B40] text-start">
          {title}
        </h3>
          ...
          {listServices.map((service) => (
            ...
            >
              <div className="flex flex-row items-center justify-between gap-2">
                <span className="lg:text-[24px] text-[18px] font-[500] text-[#2B2B40] text-start">
                  {service.title}
                </span>
                <svg
                ...
                >
                  <path
                    d="M6 16H26M26 16L18.5 8M26 16L18.5 24"
                    stroke="#2B2B40"
                    strokeWidth="1.5"
                    strokeLinecap="round"
