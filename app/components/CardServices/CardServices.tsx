...
const CardServices = ({ title, imageSrc, listServices }: CardServicesProps) => {
  return (
    <section className="flex flex-col items-start justify-start w-full bg-white rounded-[104px] rounded-b-[96px] w-[615px]">
    ...
    className="object-cover" />
      ...
      <div className="flex flex-col items-start justify-start py-[32px] px-[50px] w-full">
        <h3 className="text-[24px] font-[700] text-[#2B2B40]">{title}</h3>
