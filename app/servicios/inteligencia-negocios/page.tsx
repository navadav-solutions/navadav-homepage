...
import { questionsInteligenciaNegocios } from "@/app/data/questionsData";
import { inteligenciaNegociosData } from "@/app/data/InteligenciaNegociosData";

const InteligenciaNegocios = () => {
  return (
    <Layout>
      <ServiceHero evolutionLabel="analítica" />
      <section className="w-[80%] mx-auto py-16 text-center flex flex-col justify-center items-center">
        ...
        <p className="text-[24px] lg:text-[32px] font-[400] text-gray-600 lg:w-[80%] w-[100%] m-[0px]">
          Ayudamos a las empresas a convertir sus datos en información clara y
          confiable, mejorando la toma de decisiones y la eficiencia en toda la
          organización.
        </p>
      </section>
      ...
      <section className="w-[80%] lg:w-[60%] mx-auto py-8 text-center flex flex-col justify-center items-center gap-8">
        {questionsInteligenciaNegocios.map((question) => (
          <AccordeonCard
            key={question.title}
