...
const AutomatizacionAI = () => {
  return (
    <Layout>
      <ServiceHero evolutionLabel="de la productividad" />
      <section className="w-[80%] mx-auto py-16 text-center flex flex-col justify-center items-center">
        ...
        <p className="text-[24px] lg:text-[32px] font-[400] text-gray-600 lg:w-[80%] w-[100%] m-[0px]">
          Potenciamos la productividad de tus equipos mediante automatización e
          inteligencia artificial aplicada, liberando tus equipos de tareas
          repetitivas, permitiéndoles enfocarse en actividades de mayor valor
          para tu negocio.
        </p>
      </section>
